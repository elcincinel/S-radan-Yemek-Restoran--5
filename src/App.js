...
*/
const title = "Basit Yemekler Restoranı"
const content = "Basit insanlar için basit yemekler yapıyoruz. Sandviç ister misiniz? Tamamdır. Goralı? Hemen geliyor. Ateşte kavrulmuş kuşkonmaz börekleri ile yerel kaynaklı balla sırlanmış haşlanmış somon yumurtası? Hadi oradan. Caddenin karşısındaki Fantezi Yemek Kafe'yi deneyin."
...
function Main() {
    return(
        <main>
            <h1 className='logo-container'>{title}</h1>
            <p className='info-container'>{content}</p>
            <Image />
        </main>
    )
} 
    ...
    return (
        <div class="image-container">
            <div class="image-wrapper">
                <img class="hot-dog" src="images/hotdogs.jpg" /> </div>
                <div class="image-wrapper">
